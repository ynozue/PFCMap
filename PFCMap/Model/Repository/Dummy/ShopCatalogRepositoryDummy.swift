...
public actor ShopCatalogRepositoryDummy: ShopCatalogRepository {
    private let shops: [ShopCatalog] = [
        ShopCatalog(
            name: "ガスト", category: "ファミリーレストラン", suitabilityMark: "○",
        ...
        ShopCatalog(
            name: "サイゼリヤ", category: "ファミリーレストラン", suitabilityMark: "○",
        ...
        ShopCatalog(
            name: "大戸屋", category: "定食", suitabilityMark: "○",
        ...
        ShopCatalog(
            name: "吉野家", category: "牛丼・丼もの", suitabilityMark: "○",
        ...
        ShopCatalog(
            name: "マクドナルド", category: "ハンバーガー", suitabilityMark: "-",
